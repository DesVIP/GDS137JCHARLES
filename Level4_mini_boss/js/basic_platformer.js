...
platform1.y = platform0.y - 150;
platform1.color = "#66ff33";

platform2 = new GameObject();
platform2.width = 200;
platform2.x = platform1.x;
platform2.y = platform1.y - 200;
platform2.color = "#66ff33";

platform3 = new GameObject();
platform3.width = 1800;
platform3.x = platform2.x;
platform3.y = platform2.y - 200;
...
function animate() {
  ...
  while (platform1.hitTestPoint(player.bottom()) && player.vy >= 1) {
    player.y--;
    player.vy = 0;
    player.canJump = true;
  }

  while (platform2.hitTestPoint(player.bottom()) && player.vy >= 1) {
    player.y--;
    player.vy = 0;
    player.canJump = true;
  }

  while (platform3.hitTestPoint(player.bottom()) && player.vy >= 1) {
    player.y--;
    player.vy = 0;
    player.canJump = true;
  }
